...
static const unsigned int pitch[12] = {854,808,762,718,678,640,604,570,538,508,480,452};
...
#define COWBELL_FILE "piano.raw8"
#define COWBELL_DATA_BYTES (6357)
...
void audio1_int_handler(void) {
		...
		custom.aud[1].ac_per = pitch[rand() % 12];
		//custom.aud[1].ac_vol = 64 * rand() % 2;
		wait_vblank();	
		wait_vblank();	
...
static struct Interrupt *old_audio0_interrupt, *old_audio1_interrupt, *old_audio2_interrupt,
	*old_audio3_interrupt;
UWORD old_intena;
...
static const char *sound_files[] = {"sr22.05k/ac_track0.raw8", "sr22.05k/ac_track1.raw8",
									"sr22.05k/ac_track2.raw8", "sr22.05k/ac_track3.raw8"};
